...
% Edits from Michael:
%
% I am quite happy with it, it is a thesis on a
% project development, therefore mainly technical in its context, a lot
% of tedious work, as you know best yourself.
%
% The only thing you might want to consider is a more extensive closing
% chapter than just 'closing thoughts' something that looks more as a
% vision towards future applications, which reactions are being targeted
% 3He(a,g), 14,15N(a,g), 12C(a,g) etc so that the reader can see what
% long term purpose the instrument has.
%
% You also might want to point out that this specific design found its
% fans in SECAR where it will be used for measuring (p,g) and (a,g)
% reactions in inverse kinematics.
%
% I think this kind of positive outlook and the connection between
% instrument development and actual physics is still missing
\section{Next Steps}
