...
% there's extra space here because of the tables...?
...
No assumed underlying distribution. The
...
Gaussian distributed. The underlying statistical
...
Gaussian distributed. For similar reasons as the
...
\subsubsection{Time}
Gaussian distribution. Our run times were recorded both
...
Poisson distribution. As each bin within the
...
Gaussian distribution. The target
