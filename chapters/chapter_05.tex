...
uncertainty. The measure target thickness is
$63.8^{+2.0}_{-1.7}$~$\mu$g/cm${}^{2}$, which does not include the uncertainty
due to SRIM, and can be used to determine the energy
loss for other particles at any energy.
