...
\begin{figure}
    \begin{center}
        % \centerline{\includegraphics[width=0.8\textwidth]{figures/5U.png}}
        \caption[Schematic of the 5U accelerator]{}
        \label{fig:5U}
    \end{center}
\end{figure}
...
\begin{figure}[t]
    \begin{center}
        % \centerline{\includegraphics[width=0.95\textwidth]%
            % {figures/faraday_cups.png}}
        \caption[Schematics of the two Faraday cup designs]{Schematics
            of the two Faraday cup designs used within St.\ George. The
            \emph{FN-style} cup (left) is used at the target location
            within the temporary commissioning chamber. The back flap
            opens to allow the beam to pass, but the remainder of the
            cup structure remains in place. The \emph{5U-style} are
            located within St.\ George and are completely removed from
            the beam line when retracted.}
        \label{fig:faraday}
    \end{center}
\end{figure}
