...
installed at the two different focal planes to detect the produced
$\alpha$-particles from the \alpa{} reaction. Incident beam rejection
was on the order of $1.5\times 10^{12}$ for the runs at the resonance
peak.
...
The 5U accelerates a high-intensity
...
\begin{figure}[h]
    \begin{center}
        ...
        \caption[Schematic of the St.\ George Wien filter]{Schematic of
            ...
            magnetic ($B$) fields allow particles with a single velocity
            to pass through undeflected. Adapted from
            \cite{Couder2008}.}
...
\begin{figure}[h]
    \begin{center}
        ...
        \caption[Locations of diagnostic equipment]{Locations of various
            ...
            planes and saddle points of the particle envelope within the
            separator. The quartz camera viewers (denoted \emph{QV}) are
            located at the exit ports of the dipoles and within the beam
            line at focal planes. Adapted from \cite{Couder2008}.}
