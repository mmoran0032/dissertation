...
\nuc{24}{Mg} within the \nuc{27}{Al} target. As the produced $\alpha$
...
Table~\ref{tab:poletip}. For the $(\rm{p},\alpha)$ experiment, the $\alpha$ particles are transported to the Wien filter focal plane while the incident
proton beam is rejected before the detector system.
...
\textbf{DEFINE RESOLVING POWER AND UNITS}
...
\begin{figure}[h]
    \begin{center}
        ...
        \caption[Horizontal $\alpha$ particle distribution]{Horizontal
            ...
            asymmetric due to the horizontal asymmetry of St.\ George. The
            count rate at the low position is not shown for simplicity.}
