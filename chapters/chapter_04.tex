...
\begin{figure}
    \begin{center}
        ...
        % \centerline{\includegraphics[width=0.8\textwidth]{figures/raytrace.png}}
...
-- run for 15 minutes or 20k counts
-- if run longer than 15 minutes, measure current every 15 minutes
-- expected alpha energy range used to determine expected counts
