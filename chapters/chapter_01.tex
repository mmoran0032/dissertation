...
Oak Ridge National Laboratory, was successfully used to study numberous
reactions, such as
\react{\mnuc{17}{F}}{\rm p}{\gamma}{\mnuc{18}{Ne}}~\ref{Chipps2009}.
The separator contains two Wien filters, a single dipole magnet, three
quadrupole triplets, and two magnetic sextupoles to provide higher-order
corrections to the transport matrix. For reaction studies, auxiliary
known reactions using stable beams were performed in order to determine
the separator properties and the phase space location ($\Delta E$
vs.~$E_{rm TOTAL}$) for the expected recoils at the detector plane. Due to
the low particle currents for radioactive beams, studies are focused on
resonance energies for the reactions.
