...
% For heavy gas, hard to create a target for it
% Need to detect the emitted gamma (high background, show ERNA plot?)
% Instead, can do inverse kinematics \react{a}{A}{B}{\gamma}
% Can detect heavy recoil with high-efficiency Si detector
% Heavy recoil emitted in narrow forward cone
% Still need to reduce the beam induced background somehow
...
% Radiative capture is \react{A}{a}{\gamma}{B}
% The $\gamma$ is emitted off at some angle
% The emission affects the momentum of the emitted recoil
% Look at three discrete cases: along +z, -z, and perpendicular to z
...
The design of recoil mass separators specifically designed to study reactions
of astrophysical interest is similar to the design and operating
characteristics of similar recoil separators designed and built around the
same time (see for instance DRS at Daresbury Laboratory~\cite{James1988}), and
many of the decisions made for optimal characteristics of the separator system
have been replicated by more modern separator systems.
