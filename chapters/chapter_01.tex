...
massive and hotter stars. These burning cycles can be thought of in
...
capture reaction}, written as \react{A}{a}{\gamma}. Both types of
...
\begin{figure}[t]
    \begin{center}
        % \centerline{\includegraphics[width=0.95\textwidth]%
        %     {figures/alpa_energy_levels.png}}
...
\begin{table}
    \begin{center}
        ...
        \begin{tabular}{SSS}
            ...
            \midrule
                $E_x$, MeV \cite{NNDC}        & 12.726 & 12.902 \\
                $E_p$, MeV                & 1.182 & 1.363 \\
...
% impossible to produce a target with the desired hevy nuclei, or the
