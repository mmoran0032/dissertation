...
% notes
% - define radiative capture reactions
% - introduce cross section
% - cross section decreases due to Coulomb barrier
- can reframe cross section as S-factor to see structure
- stars burn at lower energies, so Gamow window important
- reaction rate
- what are resonances, and why are they important?
- reaction rate for resonances, resonance strength
- can study resonances through the use of recoil separators (transition paragraph)
% end notes
...
parameter. The full Gamow factor $\rm{exp}(-2\pi\eta)$ is the probability that
an s-wave nuclei penetrates the Coulomb barrier and is the primary cause of the
strong decrease in the cross section at lower energies.
