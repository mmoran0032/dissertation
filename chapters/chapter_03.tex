...
\begin{figure}[t]
    \begin{center}
        ...
        \caption[Sketch of beam divergence due to focusing
            ...
            focusing strength of a quadrupole magnet. The short-dashed
            lines show the beam path when the quadrupole is over-focused
            and the long-dashed lines show the beam path when the
            quadrupole is underfocused. At a set distance from the
            magnet and for a set particle rigidity, the physical extent
            of the beam envelope and the angular spread of particle
            trajectories changes depending on the focusing strength of
            the magnet.}
...
\begin{figure}[t]
    \begin{center}
        ...
        \caption[Sketch of quadrupole steering of misaligned
            ...
            axis. Assuming that no higher order corrections are made,
            the beam appears to scan across the observation plane as the
            magnetic field is increased, with the field strength
            increasing for line styles long-dashed, solid,
            short-dashed.}
        \label{fig:steering}
    \end{center}
\end{figure}
