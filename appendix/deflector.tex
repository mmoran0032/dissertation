...
Deflector settings used for commissioning work. Voltages are based on the
physical characteristics of the deflector system and the beam properties to
provide the necessary deflection. Setpoints are based on the version of the
control program in place at the time of the experiments.
    ...
    \begin{center}
        ...
        \begin{tabular}{S[table-format=2.0]S[table-format=2.4]%
            ...
            & \multicolumn{2}{c}{\textbf{$\mnuc{1}{H}^{+}$ at 1 MeV}} &
                \multicolumn{2}{c}{\textbf{$\mnuc{4}{He}^{+}$ at 2.3 MeV}} \\
